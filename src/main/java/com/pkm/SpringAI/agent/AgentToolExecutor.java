...
public class AgentToolExecutor {
    ...
    public AgentToolExecutor(@Qualifier("qwen2ChatModel") ChatModel chatModel, List<AgenticTool> tools) {
        this.chatClient = ChatClient.builder(chatModel)
                .defaultTools(tools.toArray(new AgenticTool[0]))
